...
// Inka istemal hota hai program mein ek ya multiple conditions ko check karne ke liye, 
// aur phir unke accordingly kuch actions perform kiye jate hain.
// 1_ if statement: if statement ek single condition ko check karta hai, aur agar ye condition true hoti hai
// to uss condition ke andar wale block ko execute karta hai. Agar condition false hoti hai, 
...
// <-------------------------------------------END----------------------------------------------->
// Conditional Ternary operators
// Conditional ternary operator, ? mark aur : symbols se represent kiya jata hai, 
// ye aik condition ko check karta hai, aur phir doosre do expressions mein se 
...
// aik jab condition true hoti hai aur doosra jab condition false hoti hai.
...
//  alag alag jagahon par use kar sakte hain is tarhan ham code ko aik sath likhne ke bajaye usy small manageable
